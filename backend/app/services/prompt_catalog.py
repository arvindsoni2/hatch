...
_CONTRACT_LIST = (
    ...
    _contract(
        _metadata("coach_conversational_evaluation"),
        "backend/app/prompts/coach_conversational_evaluation.j2",
        "coach_conversational_review",
        "ConversationalRubric",
        candidate="high",
        numeric="low",
    ),
    _contract(
        _metadata("coach_evidence_grounding"),
        "backend/app/prompts/coach_evidence_grounding.j2",
        "coach_conversational_review",
    ...
    _contract(
        _metadata("coach_follow_up"),
        "backend/app/prompts/coach_follow_up.j2",
        "coach_conversational_review",
        "FollowUpDecision",
        candidate="high",
        numeric="low",
    ...
    _contract(
        _metadata("coach_coaching"),
        "backend/app/prompts/coach_coaching.j2",
        "coach_conversational_review",
        "CoachAnswerReview",
        candidate="high",
        numeric="high",
