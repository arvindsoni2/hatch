...
export default function Error({ error, reset }: { error: Error; reset: () => void }) {
  return (
    ...
    >
      <h2 className="text-lg font-semibold text-[var(--danger)]">Applications could not load</h2>
      ...
      <p className="mx-auto mt-2 max-w-md text-sm text-[var(--text-dim)]">
        Retry the page, or open Diagnostics if the application board keeps failing.
      </p>
