  ...
  return (
    <section className="space-y-4" aria-labelledby={`${title.toLowerCase().replace(/\s+/g, "-")}-heading`}>
      <div>
        ...
        <p className="mt-1 max-w-[70ch] text-sm text-[var(--text-dim)]">{description}</p>
      </div>
      {children}
    </section>
  );
...
export default async function AnalyticsPage() {
  ...
  return (
    <PageContainer width="wide" className="px-4 py-6 sm:px-6 sm:py-8">
      <div className="space-y-8">
        <div>
          <BackButton href="/today" label="Today" />
          <PageHeader
            title="Analytics"
            description="Track outcomes, match quality, AI usage, and reliability across your search."
            className="mt-3"
          />
        </div>
        ...
        <AnalyticsSection
          title="Outcomes"
          description="Application movement and response indicators from tracked roles."
        >
        ...
        <AnalyticsSection
          title="Match Quality"
          description="Scoring, funnel, source, and skill evidence that explains which roles are worth more attention."
        >
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-xl p-6" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
              <h3 className="text-sm font-semibold mb-1" style={{ color: "var(--text)" }}>Score Distribution</h3>
            ...
            <div className="rounded-xl p-6" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
              <h3 className="text-sm font-semibold mb-4" style={{ color: "var(--text)" }}>Application Funnel</h3>
          ...
          <div className="rounded-xl p-6" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
            <h3 className="text-sm font-semibold mb-1" style={{ color: "var(--text)" }}>ATS Score → Response Rate</h3>
            <p className="text-xs mb-4" style={{ color: "var(--text-muted)" }}>
          ...
          <div className="rounded-xl p-6" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
            <h3 className="text-sm font-semibold mb-2" style={{ color: "var(--text)" }}>ATS Score → Response Rate</h3>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl p-6" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
              <h3 className="text-sm font-semibold mb-4" style={{ color: "var(--text)" }}>Source Breakdown</h3>
          ...
          <div className="rounded-xl p-6" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <h3 className="text-sm font-semibold mb-1" style={{ color: "var(--text)" }}>Skill Demand & Profile Gaps</h3>
            ...
            {(() => {
              ...
              return (
                <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_1fr_0.8fr]">
                  <div className="space-y-3">
                    <div>
                      <h4 className="text-xs font-semibold uppercase tracking-wide" style={{ color: "var(--text-dim)" }}>Market Demand</h4>
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="text-xs font-semibold uppercase tracking-wide" style={{ color: "var(--text-dim)" }}>Missing From Profile</h4>
                  ...
                  <div className="rounded-lg p-4" style={{ background: "var(--surface-2)", border: "1px solid var(--border)" }}>
                    <h4 className="text-xs font-semibold uppercase tracking-wide" style={{ color: "var(--text-dim)" }}>Next Action</h4>
                    {gaps.length > 0 ? (
                      <>
        ...
        <AnalyticsSection
          title="AI Usage"
          description="LLM spend and provider limits for local and cloud-backed agents."
        >
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              <h3 className="text-sm font-semibold" style={{ color: "var(--text)" }}>LLM Cost Tracking (30 days)</h3>
              {costsMonthly && (
        ...
        {rateLimitStatus && (
          <div className="rounded-xl p-6" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
            <h3 className="text-sm font-semibold mb-1" style={{ color: "var(--text)" }}>LLM Rate Limit Health</h3>
        ...
        <AnalyticsSection
          title="Reliability"
          description="Agent run health and failure evidence for operational confidence."
        >
          <div className="rounded-xl p-6" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
