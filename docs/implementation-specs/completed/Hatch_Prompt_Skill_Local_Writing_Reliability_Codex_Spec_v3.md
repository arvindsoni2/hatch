---
title: Hatch Prompt Skill And Local Writing Reliability Specification v3
...
superseded_by:
  - Hatch_Prompt_Skill_Local_Writing_Reliability_Codex_Spec_v4.md
---

# Hatch Prompt, Skill, and Local Writing Reliability Implementation Specification v3
...
**Accepted implementation baseline:** baseline PR merge SHA, recorded by PR 1 as specified in section 5.1.1  
...
4. Add this v3 specification under the canonical active documentation hierarchy.
5. The baseline PR must contain only:
   - the nine benchmark commits;
   - this specification;
   - any minimal documentation-index update needed to expose the specification;
...
### 5.1.1 Baseline commit recording
