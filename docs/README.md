...
- [Conversational AI Interview Coach Phase 1 implementation specification v5](implementation-specs/active/Hatch_Conversational_AI_Interview_Coach_Phase1_Implementation_Spec_v5.md)
